...
class UserModel(BaseModel):
    ...
    name: Mapped[str] = mapped_column(String(50), nullable=False, comment="Name of the user")
    age: Mapped[int] = mapped_column(Integer, nullable=False, comment="Age of the pet in years")
    month: Mapped[int] = mapped_column(Integer, nullable=False, comment="Remaining months to complete age in years")
    breed = mapped_column(String(100), nullable=False, comment="Breed of the pet")
    gender = mapped_column(String(10), nullable=False, comment="Gender of the pet")
    weight = mapped_column(Integer, nullable=False, comment="Weight of the pet")
    color: Mapped[str] = mapped_column(String(50), nullable=False, comment="Color of the pet")
    image_urls: Mapped[JSON] = mapped_column(JSON, nullable=True, comment="List of image URLs of the pet")
...
#     owner_consent_given: bool = Field(False,
#                                       description="Indicates whether the pet owner has given consent for hosting")
#     medical_emergency_consent: bool = Field(False,
#                                             description="Indicates whether the pet owner has authorized medical intervention in emergencies")
